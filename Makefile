.PHONY: docker-doctor docker-full-up docker-full-validate docker-full-down docker-shell local-full-up local-full-validate local-full-down vps-docker-up vps-docker-validate vps-docker-down
